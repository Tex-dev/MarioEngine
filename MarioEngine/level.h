...
typedef struct sLevel
{
	...
	int				playerPosX;		/**<	Position of the player at the beginning of the level in x-axis (number of sprite).		*/
	int				playerPosY;		/**<	Position of the player at the beginning of the level in y-axis (number of sprite).		*/

	SDL_Rect		renderRect;		/**<	Render rectangle of the level.															*/
